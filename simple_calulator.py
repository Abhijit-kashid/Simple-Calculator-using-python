...
class Calc():
    ...
    def numberEnter(self, num):
        ...
        if self.input_value:
            ...
            print ("self.current in numberEnter if function:",self.current)
            ...
            print ("self.current else function:",self.current)
    ...
    def display(self, value):
        ...
        print ("value in display function:",value)
